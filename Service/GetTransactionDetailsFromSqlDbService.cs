...
{
    class GetTransactionDetailsFromSqlDbService
    {

        internal class SqlTransactionDetailService : IHostedService, IDisposable
        {
            ...
            public SqlTransactionDetailService(ILogger<SqlTransactionDetailService> logger, IConfiguration config,
